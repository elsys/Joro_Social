...
<script type="text/javascript">
  ...
  function initialize() {
    ...
    map = new google.maps.Map(document.getElementById("placeAddMap"),myOptions);		
		...
		if (status == google.maps.GeocoderStatus.OK) {
		  if (results[0]) {
			  ...
			  google.maps.event.addListener(lastPlaceAddMarker, 'click', function() {
				  map.setCenter(lastPlaceAddMarker.position);
				  map.setZoom(16);
			  });
   ...
   $(function() {
		$( "#address" ).autocomplete({
			...
			select: function( event, ui ) {
				...
				map.setCenter(lastPlaceAddResult.geometry.location);
				    ...
				    <div class="tab_container">
				        ...
				        <div id="placeAddSteps-2">
							...
							<div class="clear"></div>
					    		...
					    		<div class="input-holder">
						    		<label class="label">От нета</label> <input type="text" class="inputText" />
						    		<small>Пример: http://upload.wikimedia.org/wikipedia/commons/1/16/Tsarevets-Panorama.jpg</small>
					    		</div>
					    		<div class="input-holder">
					    			<label class="label">Прикачени</label>
						    		<div class="attachments" style="margin-left: 10px;">
					    		...
					    		<h4 class="titleBlock br4">Видео</h4>
					    		<div class="input-holder">
						    		<div class="videoupload-underconstruction"></div>
						    		<label class="label">Качи видео</label> <input type="file" class="inputText" />
					    		...
					    		<div class="input-holder">
					    			<label class="label">Прикачени</label>
						    		<div class="attachments video" style="margin-left: 10px;">
										<a href="#"><img src="sources/images/sample1.jpg" alt="" /></a>
										<a href="#"><img src="sources/images/sample2.jpg" alt="" /></a>
									</div>
								</div>
					    		<div class="input-holder" style="border: 0px;">
						    		<a href="#step3" class="fr btn30 tabLink">Стъпка 3 &raquo;</a>
					    		</div>
						...
						<div id="placeAddSteps-3">
				            
				            <div class="step3"></div>
							<div class="clear"></div>
					    	
					    	
					    		<h4 class="titleBlock br4">Бизнес опции</h4>
					    		
					    		Листинг с бизнес плановете и съответните им опции. 
					    		По дефаулт - безплатен план.
