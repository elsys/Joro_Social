<? get_header();?>
<script type="text/javascript" src="sources/js/event/index.js"></script>
<script type="text/javascript">
var event_id=<?=$event->id;?>;
var geotagPlaceId=<?=$event->place_id;?>;
</script>
				    ...
				    <div class="tab_container">
				        <div id="info" class="tab_content">
				            ...
				            <div class="left-subcol">
				            	...
				            	<div class="box">
				            		<div class="subcat">
				            			<a id="going-btn" class="going-btn" style="width: 198px; margin: 0px; border: 1px solid #e8e8e8;"><b>Отивам</b> <span></span></a>                                    
				            		</div>
				            	</div>
				            	<? endif;?>
