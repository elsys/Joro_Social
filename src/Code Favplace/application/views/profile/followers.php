				...
				<div class="cbox-middle br4">
						...
						<div class="text-description">
                            ...
                            <? foreach($followers->result() as $follower):?>
								<div class="ibox br4">
									<h4>
                                    	<a href="<?=profile_link($follower->username);?>"><?=$follower->username;?></a>
                                    </h4>	
									<a href="<?=profile_link($follower->username);?>">
                                    	<img src="<?=profile_avatar($follower->follower_id,150);?>" alt="" height="160" />
                                    </a>
                                    <? if($follower->followed_id==$this->profile_id and $follower->followed):?>
                                    <a onclick="profileUnfollow('<?=$follower->username;?>',this)"                                     class="follow-btn following">
